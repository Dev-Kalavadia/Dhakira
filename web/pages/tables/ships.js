...
export default function DataTable() {
    ...
    const getData = async () => {
        ...
        const results = await fetch(`http://localhost:3000/ships?skip=${pageNumber*100}&sortBy=${sortBy}&sortType=${sortType}`)
        //const results = await fetch(`http://localhost:3000/ships/search?shipName=amsterdam&skip=0`)
        //const results = await fetch(`http://localhost:3000/ships?skip=0&arrivalFrom=1595&arrivalTo=1595&date=1`)
        ...
        setshipsData(shipsData.concat(data.docs)) // issue is here
    ...
    const extrainfo = async () =>{
        const results2 = await fetch(`http://localhost:3000/ships/1`)
